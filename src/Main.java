...
public class Main {
    public static void main(String[] args) {
        String inputFilePath = "E:\\XSET\\8 Поток XSET\\НТ~\\IdeaProjects\\DZ24\\src/text.txt"; // Путь к входному файлу
        String outputFilePath = "E:\\XSET\\8 Поток XSET\\НТ~\\IdeaProjects\\DZ24\\src/text1.txt"; // Путь к выходному файлу
